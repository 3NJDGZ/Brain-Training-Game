...
class Game:
    def __init__(self):
        ...
        self.__registration_confirmation_screen = Registration_Confirmation_Screen("Registration Confirmation!")
        self.__login_screen = Login_Screen("Login!")
        self.screens = [self.__intro_screen, self.__register_screen, self.__login_screen, self.__registration_confirmation_screen]
    ...
    def check_if_screen_is_registration_confirmation(self):
        if not isinstance(self.__current_screen, Registration_Confirmation_Screen):
            ...
            self.__current_screen.show_UI_elements()
            if self.__current_screen.check_if_user_presses_space():
